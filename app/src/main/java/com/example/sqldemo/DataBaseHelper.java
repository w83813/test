...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public List<CustomerModel> getEveryone(){
        ...
        String querytString = "SELECT * FROM " + CUSTOMER_TABLE;

        SQLiteDatabase db = this.getReadableDatabase();

        Cursor cursor = db.rawQuery(querytString, null);

        if(cursor.moveToFirst()){
            // loop through the cursor (result set) and create new customer object. Put them into return list.
            do{
